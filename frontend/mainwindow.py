...
#
# Created: Tue Dec 22 21:08:32 2009
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.recognizeImageLabel.setAlignment(QtCore.Qt.AlignCenter)
        self.recognizeImageLabel.setObjectName("recognizeImageLabel")
        self.recognizedImageLabel = QtGui.QLabel(self.centralwidget)
        self.recognizedImageLabel.setGeometry(QtCore.QRect(300, 340, 301, 151))
        self.recognizedImageLabel.setAlignment(QtCore.Qt.AlignCenter)
        self.recognizedImageLabel.setObjectName("recognizedImageLabel")
